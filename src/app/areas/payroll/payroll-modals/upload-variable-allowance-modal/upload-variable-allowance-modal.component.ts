...
@Component({
    selector: 'app-payroll-upload-variable-allowance-modal',
    templateUrl: './upload-variable-allowance-modal.component.html'
})

export class UploadVariableAllowanceModalComponent implements OnInit {
    datePickerConfig: Partial<BsDatepickerConfig> = {};
    @Output() closeModalEvent = new EventEmitter<string>();

    @ViewChild('uploadMonthlyVariableAllowanceModal', { static: true }) uploadMonthlyVariableAllowanceModal!: ElementRef;
    ...
    uploadFormInit() {
        ...
        this.loadAllowances();
        this.modalService.open(this.uploadMonthlyVariableAllowanceModal, "sm");
    ...
    submit() {
        if (this.uploadForm.valid) {
            ...
            formData.append('AllowanceNameId', this.uploadForm.get('allowanceNameId').value.toString());
            ...
            this.areasHttpService.observable_post<any>((ApiArea.payroll + "/Salary/VariableAllowance" + "/UploadMonthlyVariableAllowances"),
