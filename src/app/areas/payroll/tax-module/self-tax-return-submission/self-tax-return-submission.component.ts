...
@Component({
    selector: 'app-payroll-self-tax-return-submission',
    templateUrl: './self-tax-return-submission.component.html',
    animations: [
...
export class SelfTaxReturnSubmissionComponent implements OnInit {
    ...
    getEmployeeTaxReturnSubmissionList() {
        this.taxReturnSubmissioinService.getEmployeeTaxReturnSubmissionAsync({ employeeId: this.User().EmployeeId.toString() }).subscribe(response => {
            this.list = response;
