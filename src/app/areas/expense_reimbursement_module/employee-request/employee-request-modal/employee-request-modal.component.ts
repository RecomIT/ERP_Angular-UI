...
@Component({
  selector: 'expense-reimbursement-module-employee-request-modal',
  templateUrl: './employee-request-modal.component.html'

})
export class EmployeeRequestModalComponent implements OnInit {
  ...
  formInit() {
    ...
    this.transactionForm.get('transactionType').valueChanges.subscribe(value => {
      ...
      if (this.transactionType != "") {
        ...
        this.getRequestCountEmployeeWise();
  ...
  resetFormArray() {
    ...
    console.log("this.spendMode>>>", this.spendMode);
  ...
  //     purchaseString += `${items},${quantity},${price},${amount}`;
  //     if (index < this.formArray.length - 1) {
  //       purchaseString += ',';
  //     }
  //   });
  ...
  //   formData.append('requestId', this.id.toString());
  //   let transactionDate = new Date(this.transactionForm.get('transactionDate').value).toISOString();
  //   let requestDate = new Date(this.requestFormEntertainment.get('requestDate').value).toISOString();
  ...
  //   formData.append('purpose', this.requestFormEntertainment.get('purpose').value);
  //   formData.append('spendMode', this.requestFormEntertainment.get('spendMode').value);
  //   formData.append('purchases', purchaseString);
  //   formData.append('cost', purchaseCost.toString());
  //   formData.append("file", this.requestFormEntertainment.get('file').value);
  //   formData.append('flag', this.emailFlag === "" ? flag : this.emailFlag);

  //   // formData.append('fileName', this.fileName);
  //   // formData.append('actualFileName', this.actualFileName);
  ...
  //     referenceNumber: this.requestFormEntertainment.get('refNo').value,
  //     purpose: this.requestFormEntertainment.get('purpose').value,
  //     spendMode: this.requestFormEntertainment.get('spendMode').value,
  //     purchases: purchaseString,
  //     cost: purchaseCost,
  //     file: this.requestFormEntertainment.get('file').value,
  //     flag: this.emailFlag === "" ? flag : this.emailFlag
  //   };
  ...
  //   // formData.forEach((value, key) => {
  //   //   console.log("formData Purchase>>",`${key}: ${value}`);
  //   // });

  //   // console.log("params Purchase>>", params);

  //   this.employeeRequestSerive.savePurchase(formData).subscribe(
  //     response => {
