...
export class RequestApprovalSerive{
    private apiRoot = ApiArea.expensereimbursement + "/Request/Approval";
    ...
    getAdvance(params: any) {
        return this.areasHttpService.observable_get<any>((this.apiRoot + "/GetRequestDataAdvance"), {
            responseType: "json", observe: 'response', params: params
        });
    }
    ...
    getRequestCountAdvance(params: any) {
        return this.areasHttpService.observable_get<any>((this.apiRoot + "/GetRequestCountAdvance"), {
            responseType: "json", observe: 'response', params: params
        });
    }

    getByAdvanceId(params: any) {
        return this.areasHttpService.observable_get<any>((this.apiRoot + "/GetRequestDataByAdvanceId"), {
