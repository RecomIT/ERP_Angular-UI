...
export class ReplacementComponent implements OnInit {
  ...
  constructor(
    ...
    private replacementSerive: ReplacementSerive,
  ...
  getAssetData() {
    ...
    this.list = []
    this.replacementSerive.get(params).subscribe(response => {
  ...
  // employeeId: number = 0;
  // type : string = '';
  // showModal(employeeId : any, type : any) {
