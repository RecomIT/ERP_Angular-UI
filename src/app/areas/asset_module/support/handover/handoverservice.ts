...
export class HandoverSerive{
    private apiRoot = ApiArea.asset + "/Support/Handover";
    ...
    get(params: any) {
        return this.areasHttpService.observable_get<any>((this.apiRoot + "/GetHandoverData"), {
    ...
    save(params: any) {
        return this.areasHttpService.observable_post<any>((this.apiRoot+ "/SaveHandover"), params, {
            responseType: "json", observe: 'response',params: params
        });
    }
