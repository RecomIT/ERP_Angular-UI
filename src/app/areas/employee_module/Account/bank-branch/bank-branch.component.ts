...
@Component({
    selector: 'employee-module-bank-branch',
...
export class BankBranchComponent implements OnInit {
    ...
    constructor(private utilityService: UtilityService, private bankBranchService: BankBranchService) {
    }
    ...
    get() {
        this.bankBranchService.get({}).subscribe((response) => {
            this.list = response;
