...
@Component({
    selector: 'app-hr-employee-module-department',
...
export class DepartmentComponent implements OnInit {
    ...
    constructor(private utilityService: UtilityService, private departmentService: DepartmentService) {
    }
    ...
    get() {
        this.departmentService.get({}).subscribe((response) => {
            this.list = response;
