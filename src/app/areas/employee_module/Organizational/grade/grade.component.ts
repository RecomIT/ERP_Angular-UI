...
@Component({
    selector: 'employee-module-grade',
...
export class GradeComponent implements OnInit {
    ...
    constructor(private utilityService: UtilityService, private gradeService: GradeService) {
    }
    ...
    get() {
        this.gradeService.get({}).subscribe((response) => {
            this.list = response;
