...
@Component({
  selector: 'app-approve-resignation-by-admin',
  templateUrl: './approve-resignation-by-admin.component.html',
  styleUrls: ['./approve-resignation-by-admin.component.css']
})
export class ApproveResignationByAdminComponent implements OnInit {
  ...
  submitApprove() {
      if (this.approveForm.valid) {
          ...
          this.ExecutionFlag = 'AdminApprove';
